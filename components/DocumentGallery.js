    ...
    return(
        <div className={styles.galleryContainer}>
                ...
                <div className={styles.gallery} ref={galleryRef}>
                            ...
                            <Link className={styles.galleryImage_div} href={"https://drive.google.com/file/d/1r_kPNnHk6Jf8HH9AfR_efZjaxqYTvZd_/view?usp=sharing"} target='_blank' rel='noopener noreferer'>
                            ...
                            <Link className={styles.galleryImage_div} href={"https://drive.google.com/file/d/1JuAPjl4DkwbFLUl4zd-Odjut0WIeLNYR/view?usp=sharing"} target='_blank' rel='noopener noreferer'>
